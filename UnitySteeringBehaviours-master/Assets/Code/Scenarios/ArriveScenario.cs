...
namespace BGE.Scenarios
{
    public class ArriveScenario : Scenario
    {
        ...
        public override void Start()
        {
            ...
            leader.GetComponent<SteeringBehaviours>().seekTargetPos = new Vector3(-30, 30, 160);
			leader.GetComponent<SteeringBehaviours>().maxSpeed = 2000;
			leader.GetComponent<SteeringBehaviours>().maxForce = 100;
